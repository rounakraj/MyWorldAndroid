...
public class FollowersAdapter extends RecyclerView.Adapter<FollowersAdapter.CustomViewHolder> {
    ...
    public FollowersAdapter(Context context, ArrayList<Follower> followers, FollwerCallback callback) {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_rowfollowers,viewGroup, false);
