...
import com.app.shopchatmyworldra.pojo.PopularItemResources;
...
public class PopularAdapter  extends RecyclerView.Adapter<PopularAdapter.ItemServideViewHolder> {

    private List<PopularItemResources> itemList;
    private Activity context;
    int mpostion;

    public PopularAdapter(Activity context, List<PopularItemResources> itemList) {
    ...
    public ItemServideViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.popularitem, null);
    ...
    class ItemServideViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        private PopularAdapter.ItemClickListener clickListener;
        public View view;
        ...
        public void setClickListener(PopularAdapter.ItemClickListener itemClickListener) {
