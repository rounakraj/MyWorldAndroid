...
public class DealsAdapter extends RecyclerView.Adapter<DealsAdapter.ItemServideViewHolder> {

    private List<DealsResources> itemList;
    private Activity context;
    int mpostion;

    public DealsAdapter(Activity context, List<DealsResources> itemList) {
    ...
    public ItemServideViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.dealsitem, null);
    ...
    class ItemServideViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        private DealsAdapter.ItemClickListener clickListener;
        public View view;
        ...
        public void setClickListener(DealsAdapter.ItemClickListener itemClickListener) {
