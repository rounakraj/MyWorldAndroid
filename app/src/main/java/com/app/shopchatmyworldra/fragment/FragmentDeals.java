...
public class FragmentDeals extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.activity_deals, null);
            ...
            if (response.getString("responseCode").equals("200")) {
                ...
                if (response.get("productServer") instanceof JSONArray) {
                    ...
                    if (serviceListData != null) {
                        mAdapter = new DealsAdapter(mactivity, serviceListData);
                        recyclerView.setAdapter(mAdapter);
                    } else {
                    }
                } else {

                    CommanMethod.showAlert("No Product Found.", mactivity);
                }
            } else {
