...
import com.app.shopchatmyworldra.adapter.PopularAdapter;
...
public class FragmentPopular extends Fragment {
    ...
    private ArrayList<PopularItemResources> serviceListData = new ArrayList<PopularItemResources>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.activity_popular, null);
    ...
    private void GETpopularitem() {
        ...
        client.post(WebServices.getpopularProduct, params,
        ...
        try {
            ...
            if (response.getString("responseCode").equals("200")) {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    PopularItemResources mRide = new PopularItemResources();
                ...
                if (serviceListData != null) {
                    mAdapter = new PopularAdapter(mactivity, serviceListData);
